...
export default function AdminDestinationsIndex({ destinations, cities, categories, filters }: Props) {
    ...
    return (
        <AdminLayout breadcrumbs={[{ title: 'Data Tempat Wisata', href: '/admin/destinations' }]}>
            <Head title="Kelola Destinasi" />

            <div className="mb-6 flex items-center justify-between">
                <h1 className="text-2xl font-bold text-gray-800">Data Tempat Wisata</h1>
                <Link
            ...
            <div className="bg-white border rounded-xl p-4 mb-6 flex flex-wrap gap-3">
                ...
                {(search || city || category) && (
                    <button
                        onClick={() => { setSearch(''); setCity(''); setCategory(''); router.get(route('admin.destinations.index')); }}
